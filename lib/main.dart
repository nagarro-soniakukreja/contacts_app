...
import 'package:contactsapp/blocs/blocs_observer.dart';
...
import 'package:contactsapp/screens/home_screen.dart';
...
void main() {
  ...
  runApp(BlocProvider(
      create: (context) {
        return ContactsBloc(contactsRepository: ContactsRepository())
          ..add(ContactsRequested());
      },
      child: BlocProvider(
        create: (context) {
          return FavoriteContactsBloc(contactsRepository: ContactsRepository())
            ..add(FavoriteContactRequested());
        },
        child: MaterialApp(
